...
ASSET_MANAGER.queueDownload("./assets/flame_tower.png");
...
ASSET_MANAGER.queueDownload("./assets/map_bg_hard.png");
...
ASSET_MANAGER.queueDownload("./data/FlameTower.json");
...
ASSET_MANAGER.queueDownload("./data/map_hard.json");
